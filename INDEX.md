...
|---|---------------------------|----------------|
| ১ | নির্বাহী সারসংক্ষেপ (Executive Summary) | [Line 33](#L33) |
| ২ | প্রজেক্টের দৃষ্টিভঙ্গি ও উদ্দেশ্য (Vision & Objectives) | [Line 58](#L58) |
| ৩ | সমস্যা বিবৃতি (Problem Statement) | [Line 90](#L90) |
| ৪ | প্রস্তাবিত সমাধান (Proposed Solution) | [Line 120](#L120) |
| ৫ | সিস্টেম আর্কিটেকচার (System Architecture) | [Line 152](#L152) |
| ৬ | কারিগরি স্ট্যাক ও প্রযুক্তি (Technology Stack) | [Line 305](#L305) |
| ৭ | বাস্তবায়ন পরিকল্পনা (Implementation Plan) | [Line 355](#L355) |
| ৮ | অটোমেশন ওয়ার্কফ্লো (Automation Workflow) | [Line 517](#L517) |
| ৯ | নিরাপত্তা ও সম্মতি (Security & Compliance) | [Line 838](#L838) |
| ১০ | ঝুঁকি ব্যবস্থাপনা (Risk Management) | [Line 922](#L922) |
| ১১ | পরীক্ষণ কৌশল (Testing Strategy) | [Line 959](#L959) |
...
**Location Reference**: [Line 160-165](#L160)
...
**Location Reference**: [Line 167-170](#L167)
...
**Location Reference**: [Line 172-175](#L172)
...
**Location Reference**: [Line 177-190](#L177)
...
**Location Reference**: [Line 192-206](#L192)

#### Core Scripts
**Location Reference**: [Line 193-196](#L193)
...
#### Automation Scripts
**Location Reference**: [Line 198-201](#L198)
...
#### Utility Scripts
**Location Reference**: [Line 203-206](#L203)
...
**Location Reference**: [Line 208-211](#L208)
...
### Documentation (Docs/)
**Location Reference**: [Line 213-216](#L213)
...
**Location Reference**: [Line 225-266](#L225)

| Layer | Description | Line Reference |
|-------|-------------|----------------|
| **USER INTERFACE LAYER** | Start-Tool.bat / GUI | [Line 226-227](#L226) |
| **ORCHESTRATION LAYER** | PowerShell Core Scripts | [Line 232-236](#L232) |
| **AUTOMATION ENGINE LAYER** | Selenium WebDriver + Custom Logic | [Line 241-245](#L241) |
| **COMMUNICATION LAYER** | Chrome DevTools Protocol (CDP) | [Line 250-252](#L250) |
| **BROWSER RUNTIME LAYER** | Chrome Portable + Extensions | [Line 257-259](#L257) |
| **TARGET APPLICATION LAYER** | DeepSeek, Gemini | [Line 264-265](#L264) |

### Technology Stack
**Location Reference**: [Line 309-323](#L309)

| Component | Technology | Version | Line Reference |
|-----------|-----------|---------|----------------|
| Scripting Engine | PowerShell | 5.1+ / Core 7.x | [Line 315](#L315) |
| Automation Framework | Selenium | WebDriver 4.x | [Line 316](#L316) |
| Browser Runtime | Chrome Portable | Latest Stable 120+ | [Line 317](#L317) |
| Driver Interface | ChromeDriver | Auto-matched | [Line 318](#L318) |
| Communication | DevTools Protocol | CDP | [Line 319](#L319) |
| Configuration | JSON | UTF-8 | [Line 320](#L320) |
| Logging | Plain Text | Timestamp-based | [Line 321](#L321) |
| Data Storage | File System | Portable directory | [Line 322](#L322) |

### .NET Library Dependencies
**Location Reference**: [Line 325-341](#L325)
...
**Location Reference**: [Line 343-353](#L343)
...
**Location Reference**: [Line 362-373](#L362)
...
**Location Reference**: [Line 376-391](#L376)
...
**Location Reference**: [Line 394-410](#L394)
...
**Key Functions**:
- `Find-Element($selector, $timeout)` → [Line 407](#L407)
- `Type-Text($element, $text, $humanLike=$true)` → [Line 408](#L408)
- `Wait-ForResponse($maxSeconds)` → [Line 409](#L409)
- `Click-Element($element, $verify=$true)` → [Line 410](#L410)

### Phase 3: AI প্ল্যাটফর্ম ইন্টিগ্রেশন (AI Platform Integration)
**Timeline**: সপ্তাহ ৮-৯ (Week 8-9)  
**Location Reference**: [Line 413-423](#L413)
...
**Location Reference**: [Line 426-440](#L426)

**Tasks**:
- Anti-Detection.ps1 তৈরি
  - Random delay generator (3-7s, Gaussian distribution) → [Line 429](#L429)
  - Typing speed variation (150-300 ms per character) → [Line 430](#L430)
  - Mouse movement simulation (optional)
  - User-Agent rotation
- Smart-Wait.ps1 উন্নয়ন
  - Loading indicator detection → [Line 434](#L434)
  - Text change monitoring → [Line 435](#L435)
  - Network idle detection → [Line 436](#L436)
...
**Location Reference**: [Line 443-449](#L443)
...
**Location Reference**: [Line 452-464](#L452)

**Tasks**:
- Logger.ps1 তৈরি
  - Timestamp-based logging → [Line 455](#L455)
  - Log level system (INFO, WARN, ERROR) → [Line 456](#L456)
  - Automatic log rotation (daily files) → [Line 457](#L457)
- Performance metrics tracking
  - Action execution time → [Line 459](#L459)
  - Response wait duration → [Line 460](#L460)
  - Success/failure rate → [Line 461](#L461)
...
**Location Reference**: [Line 467-476](#L467)
...
**Location Reference**: [Line 479-486](#L479)
...
**Location Reference**: [Line 489-495](#L489)
...
**Location Reference**: [Line 498-504](#L498)
...
**Location Reference**: [Line 507-515](#L507)

| Milestone | Week | Description | Line Reference |
|-----------|------|-------------|----------------|
| **M1** | সপ্তাহ ৪ | Working Portable Environment | [Line 510](#L510) |
| **M2** | সপ্তাহ ৭ | Core Automation Engine Functional | [Line 511](#L511) |
| **M3** | সপ্তাহ ৯ | DeepSeek Full Integration | [Line 512](#L512) |
| **M4** | সপ্তাহ ১২ | Multi-platform Support | [Line 513](#L513) |
| **M5** | সপ্তাহ ১৫ | User-friendly Interface | [Line 514](#L514) |
| **M6** | সপ্তাহ ২০ | Production-ready Release v1.0 | [Line 515](#L515) |
...
**Location Reference**: [Line 521-561](#L521)

| Step | Description | Line Reference |
|------|-------------|----------------|
| **STEP 1** | পরিবেশ যাচাই (Environment Check) | [Line 526-531](#L526) |
| | - PowerShell version চেক (≥ 5.1) | [Line 528](#L528) |
| | - Selenium DLLs উপস্থিতি যাচাই | [Line 529](#L529) |
| | - ChromePortable.exe পাথ যাচাই | [Line 530](#L530) |
| | - Workspace ফোল্ডার তৈরি | [Line 531](#L531) |
| **STEP 2** | কনফিগারেশন লোডিং | [Line 533-538](#L533) |
| | - config.json পড়া | [Line 535](#L535) |
| | - prompts.json পড়া | [Line 536](#L536) |
| | - targets.json পড়া | [Line 537](#L537) |
| | - Validation (JSON syntax ও required fields) | [Line 538](#L538) |
| **STEP 3** | Selenium ইনিশিয়ালাইজেশন | [Line 540-549](#L540) |
| | - .NET assemblies লোড | [Line 542-544](#L542) |
| | - ChromeDriver অবজেক্ট তৈরি | [Line 546-549](#L546) |
| **STEP 4** | ব্রাউজার লঞ্চ | [Line 551-555](#L551) |
| | - Chrome Portable চালু | [Line 553](#L553) |
| | - Window size সেট করা | [Line 554](#L554) |
| | - Initial page load verification | [Line 555](#L555) |
| **STEP 5** | টার্গেট নেভিগেশন | [Line 557-561](#L557) |
| | - Navigate to target URL | [Line 559](#L559) |
| | - Page load সম্পূর্ণ হওয়া পর্যন্ত অপেক্ষা | [Line 560](#L560) |
| | - Login state চেক | [Line 561](#L561) |

### 8.2 মাস্টার প্রম্পট ইনজেকশন (Master Prompt Injection)
**Location Reference**: [Line 564-607](#L564)

| Phase | Description | Line Reference |
|-------|-------------|----------------|
| **[A]** | Textarea Element Locate করা | [Line 569-577](#L569) |
| | - Primary Strategy: CSS Selector | [Line 571-572](#L571) |
| | - Fallback Strategy: XPath | [Line 574-575](#L574) |
| | - Timeout: 30 seconds | [Line 577](#L577) |
| **[B]** | Master Prompt টাইপ করা | [Line 579-591](#L579) |
| | - config.json থেকে মাস্টার প্রম্পট লোড | [Line 581-582](#L581) |
| | - Human-like Typing Simulation | [Line 584-588](#L584) |
| | - Alternative: Direct injection | [Line 590-591](#L590) |
| **[C]** | Send Button Trigger | [Line 593-602](#L593) |
| | - Button locate করা | [Line 595-596](#L595) |
| | - Clickability চেক | [Line 598-599](#L598) |
| | - Click execution | [Line 601-602](#L601) |
| **[D]** | Initial Response Wait | [Line 604-607](#L604) |
| | - AI-এর প্রথম রেসপন্স সম্পূর্ণ হওয়া পর্যন্ত অপেক্ষা | [Line 606-607](#L606) |

### 8.3 মূল অটোমেশন লুপ (Main Automation Loop)
**Location Reference**: [Line 610-742](#L610)

| Phase | Description | Line Reference |
|-------|-------------|----------------|
| **PHASE 1: CHECK** | Element Availability Verification | [Line 620-632](#L620) |
| | - Textarea element পুনরায় locate | [Line 622-623](#L622) |
| | - Element state চেক | [Line 625-628](#L625) |
| | - Retry logic | [Line 630-632](#L630) |
| **PHASE 2: INPUT** | Text Entry | [Line 635-648](#L635) |
| | - Follow-up prompt নির্ধারণ | [Line 637-639](#L637) |
| | - Textarea clear করা | [Line 641-642](#L641) |
| | - নতুন টেক্সট টাইপ করা | [Line 644-645](#L644) |
| | - Input verification | [Line 647-648](#L647) |
| **PHASE 3: TRIGGER** | Action Execution | [Line 651-669](#L651) |
| | - Send button পুনরায় locate | [Line 653-654](#L653) |
| | - Pre-click verification | [Line 656-658](#L656) |
| | - Click action | [Line 660-666](#L660) |
| | - Action logging | [Line 668-669](#L668) |
| **PHASE 4: WAIT** | Response Completion Detection | [Line 672-717](#L672) |
| | - Smart Wait ফাংশন আহ্বান | [Line 674-675](#L674) |
| | - Method 1: Loading Indicator Disappearance | [Line 679-682](#L679) |
| | - Method 2: Text Stability Check | [Line 684-696](#L684) |
| | - Method 3: DOM Mutation Observer (JavaScript) | [Line 698-713](#L698) |
| | - Response capture (optional) | [Line 715-717](#L715) |
| **PHASE 5: DELAY** | Anti-Detection Pause | [Line 720-735](#L720) |
| | - Random delay generator | [Line 722-726](#L722) |
| | - Progress display | [Line 728-729](#L728) |
| | - Sleep execution | [Line 731-732](#L731) |
| | - Iteration completion logging | [Line 734-735](#L734) |

### 8.4 শাটডাউন সিকোয়েন্স (Shutdown Sequence)
**Location Reference**: [Line 745-777](#L745)

| Step | Description | Line Reference |
|------|-------------|----------------|
| **[1]** | Final logging | [Line 750-755](#L750) |
| | - Total iterations completed | [Line 752](#L752) |
| | - Total time elapsed | [Line 753](#L753) |
| | - Success rate calculation | [Line 754](#L754) |
| | - Error summary | [Line 755](#L755) |
| **[2]** | Data persistence | [Line 757-760](#L757) |
| | - Response archive সংরক্ষণ | [Line 759](#L759) |
| | - Session state সংরক্ষণ | [Line 760](#L760) |
| **[3]** | Browser cleanup | [Line 762-766](#L762) |
| | - Optional: Clear temporary cache | [Line 764](#L764) |
| | - Close all tabs (except first) | [Line 765](#L765) |
| | - Return to homepage | [Line 766](#L766) |
| **[4]** | WebDriver disposal | [Line 768-771](#L768) |
| | - $driver.Quit() | [Line 770](#L770) |
| | - Release .NET resources | [Line 771](#L771) |
| **[5]** | User notification | [Line 773-777](#L773) |
| | - Display success message | [Line 775](#L775) |
| | - Show log file location | [Line 776](#L776) |
| | - Exit code 0 | [Line 777](#L777) |

### 8.5 ব্যতিক্রম ব্যবস্থাপনা (Exception Handling)
**Location Reference**: [Line 780-836](#L780)
...
**Location Reference**: [Line 785-792](#L785)
...
**Location Reference**: [Line 794-800](#L794)
...
**Location Reference**: [Line 802-809](#L802)
...
**Location Reference**: [Line 811-818](#L811)
...
**Location Reference**: [Line 820-827](#L820)
...
### [E6] Browser Crash
**Location Reference**: [Line 829-836](#L829)
...
**Location Reference**: [Line 842-879](#L842)

#### ডেটা সুরক্ষা (Data Security)
**Location Reference**: [Line 845-857](#L845)

- **UserData Encryption (Optional)** → [Line 846-847](#L846)
  - AES-256 encryption for sensitive session data
- **Credential Management** → [Line 849-852](#L849)
  - Never store passwords in plain text
  - Use Windows Credential Manager integration
  - Session token handling: encrypted storage only
- **Audit Logging** → [Line 854-857](#L854)
  - All actions timestamped
  - Sensitive data redaction in logs
  - Secure log file permissions

#### নেটওয়ার্ক সুরক্ষা (Network Security)
**Location Reference**: [Line 860-868](#L860)

- **HTTPS-only connections** → [Line 861-862](#L861)
  - SSL certificate verification enabled
- **No external data transmission** → [Line 864-865](#L864)
  - All processing local, no telemetry
- **Firewall-friendly** → [Line 867-868](#L867)
  - Standard browser ports only (80, 443)

#### কোড সুরক্ষা (Code Security)
**Location Reference**: [Line 871-879](#L871)

- **Input sanitization** → [Line 872-873](#L872)
  - Prevent script injection in prompts
- **Execution policy** → [Line 875-876](#L875)
  - PowerShell script signing (optional)
- **No remote code execution** → [Line 878-879](#L878)
  - All scripts local, verified integrity

### 9.2 সম্মতি ও নৈতিকতা (Compliance & Ethics)
**Location Reference**: [Line 882-920](#L882)

#### AI Platform Terms of Service
**Location Reference**: [Line 885-897](#L885)

- **Rate Limiting Compliance** → [Line 886-889](#L886)
  - DeepSeek: Max 60 requests/hour → আমাদের ডিফল্ট: 20/hour → [Line 887](#L887)
  - Gemini: Max 100 requests/hour → আমাদের ডিফল্ট: 30/hour → [Line 888](#L888)
  - Configurable throttling mechanism → [Line 889](#L889)
- **Respectful Usage** → [Line 891-894](#L891)
  - No spamming or abusive content
  - No attempt to overload servers
  - Comply with platform usage policies
- **Disclosure** → [Line 896-897](#L896)
  - Automation is for personal productivity, not data scraping

#### ব্যবহারকারী দায়িত্ব (User Responsibility)
**Location Reference**: [Line 900-909](#L900)

- **Use Case Restrictions** → [Line 901-903](#L901)
  - ✓ Allowed: Personal research, content creation assistance
  - ✗ Prohibited: Commercial data harvesting, abuse, spam
- **Legal Compliance** → [Line 905-906](#L905)
  - User must ensure compliance with local laws
- **Liability** → [Line 908-909](#L908)
  - Tool provided "as-is", user responsible for consequences

#### Privacy Measures
**Location Reference**: [Line 912-920](#L912)

- **No Data Collection** → [Line 913-914](#L913)
  - Tool does not transmit user data anywhere
- **Local Processing Only** → [Line 916-917](#L916)
  - All logs and responses stay on user's device
- **User Control** → [Line 919-920](#L919)
...
**Location Reference**: [Line 922-957](#L922)

| Risk ID | Risk Description | Probability | Impact | Mitigation | Line Reference |
|---------|------------------|-------------|--------|------------|----------------|
| **R-001** | Bot detection by AI platforms | Medium | High | Anti-detection algorithms, human-like delays | [Line 929-931](#L929) |
| **R-002** | UI changes breaking automation | High | Medium | Multiple selector strategies, version tracking | [Line 933-935](#L933) |
| **R-003** | ChromeDriver version mismatch | Medium | High | Auto-update script | [Line 937-938](#L937) |
| **R-004** | Session expiry during long runs | Low | Medium | Session validation checks | [Line 940-941](#L940) |
| **R-005** | Network instability | Medium | Medium | Retry mechanism, state persistence | [Line 943-944](#L943) |
| **R-006** | Memory leak in long sessions | Low | High | Periodic browser restart | [Line 946-947](#L946) |
| **R-007** | ToS violation consequences | Low | High | Rate limiting, ethical usage | [Line 949-950](#L949) |
| **R-008** | Data loss due to crash | Low | Medium | Auto-save, backup mechanism | [Line 952-953](#L952) |

**Probability Scale**: Low / Medium / High → [Line 956](#L956)  
**Impact Scale**: Low / Medium / High → [Line 957](#L957)
...
**Location Reference**: [Line 963-989](#L963)

**Test Category**: INDIVIDUAL FUNCTIONS → [Line 966](#L966)

#### [TS-001] Element Locator Functions
**Location Reference**: [Line 968-972](#L968)
...
**Location Reference**: [Line 974-978](#L974)
...
**Location Reference**: [Line 980-984](#L980)
...
**Location Reference**: [Line 986-989](#L986)
...
**Location Reference**: [Line 992-1011](#L992)

**Test Category**: COMPONENT INTERACTION → [Line 995](#L995)

#### [TS-101] Full Workflow Test
**Location Reference**: [Line 997-1001](#L997)
...
**Location Reference**: [Line 1003-1006](#L1003)
...
**Location Reference**: [Line 1008-1011](#L1008)
...
**Location Reference**: [Line 1014-1040](#L1014)

**Test Category**: END-TO-END VALIDATION → [Line 1017](#L1017)

#### [TS-201] Portability Test
**Location Reference**: [Line 1019-1023](#L1019)
...
**Location Reference**: [Line 1025-1029](#L1025)
...
**Location Reference**: [Line 1031-1034](#L1031)
...
**Location Reference**: [Line 1036-1040](#L1036)
...
**Location Reference**: [Line 1043-1057](#L1043)

**Test Category**: REAL-WORLD USAGE → [Line 1046](#L1046)

#### [TS-301] Ease of Use Test
**Location Reference**: [Line 1048-1052](#L1048)
...
**Location Reference**: [Line 1054-1057](#L1054)
...
**Location Reference**: [Line 67-87](#L67)

| Objective ID | Description | Line Reference |
|--------------|-------------|----------------|
| **[OBJ-001]** | পোর্টেবিলিটি নিশ্চিতকরণ<br>→ সম্পূর্ণ self-contained পরিবেশ তৈরি<br>→ কোনো সিস্টেম ডিপেন্ডেন্সি নেই | [Line 69-71](#L69) |
| **[OBJ-002]** | ড্রাইভার-বেসড অটোমেশন<br>→ DOM ম্যানিপুলেশনের মাধ্যমে সরাসরি ইন্টারঅ্যাকশন<br>→ সাধারণ স্ক্রিপ্টিং থেকে ৩০০% দ্রুততর কর্মক্ষমতা | [Line 73-75](#L73) |
| **[OBJ-003]** | স্টেটফুল সেশন ম্যানেজমেন্ট<br>→ ইউজার লগইন সংরক্ষণ<br>→ কুকিজ এবং ক্যাশ পারসিস্টেন্স | [Line 77-79](#L77) |
| **[OBJ-004]** | Human-like Behavior Simulation<br>→ অ্যান্টি-বট মেকানিজম বাইপাস<br>→ র‍্যান্ডম টাইমিং এবং প্যাটার্ন ভ্যারিয়েশন | [Line 81-83](#L81) |
| **[OBJ-005]** | এক্সটেনসিবিলিটি<br>→ মাল্টিপল AI প্ল্যাটফর্ম সাপোর্ট<br>→ মডুলার কনফিগারেশন সিস্টেম | [Line 85-87](#L85) |

---

## ❗ PART 12: Problem Statements Reference

**Location Reference**: [Line 93-117](#L93)

| Problem ID | Description | Impact | Line Reference |
|------------|-------------|--------|----------------|
| **[P-001]** | পুনরাবৃত্তিমূলক AI ইন্টারঅ্যাকশন<br>→ রিসার্চার এবং কন্টেন্ট ক্রিয়েটরদের প্রতিদিন একই ধরনের প্রম্পট ম্যানুয়ালি ইনপুট করতে হয়<br>→ সময় ব্যয়: প্রতি সেশনে ২-৩ ঘণ্টা | High | [Line 95-98](#L95) |
| **[P-002]** | সাধারণ অটোমেশন টুলের সীমাবদ্ধতা<br>→ AutoHotkey/PyAutoGUI শুধুমাত্র মাউস/কিবোর্ড সিমুলেট করে<br>→ ব্যাকগ্রাউন্ডে কাজ করতে পারে না<br>→ পিক্সেল-বেসড অ্যাকশন অনির্ভরযোগ্য | High | [Line 100-103](#L100) |
| **[P-003]** | ইনস্টলেশন নির্ভরতা<br>→ বেশিরভাগ অটোমেশন টুলে অ্যাডমিন রাইটস প্রয়োজন<br>→ কর্পোরেট/শেয়ার্ড কম্পিউটারে ব্যবহারযোগ্য নয় | Medium | [Line 105-107](#L105) |
| **[P-004]** | বট ডিটেকশন<br>→ AI প্ল্যাটফর্মগুলো ক্রমবর্ধমানভাবে অটোমেশন শনাক্ত করছে<br>→ সাধারণ স্ক্রিপ্ট দ্রুত ব্লক হয়ে যায় | High | [Line 109-111](#L109) |

**Impact Analysis** → [Line 113-117](#L113):
...
**Location Reference**: [Line 51-55](#L51)
...
**Location Reference**: [Line 44-49](#L44)
...
**Location Reference**: [Line 142-149](#L142)
...
**Location Reference**: [Line 123-149](#L123)

#### [স্তর ১] পোর্টেবল রানটাইম পরিবেশ → [Line 127-130](#L127)
- Chrome Browser (Portable Edition)
- ChromeDriver (WebDriver Protocol)
- Selenium Libraries (.NET Bindings)

#### [স্তর ২] অটোমেশন ইঞ্জিন → [Line 132-135](#L132)
- PowerShell Core স্ক্রিপ্টিং
- JSON-বেসড কনফিগারেশন
- স্মার্ট ওয়েট মেকানিজম

#### [স্তর ৩] ইন্টেলিজেন্ট লজিক লেয়ার → [Line 137-140](#L137)
...
**Location Reference**: [Line 543-544](#L543)
...
**Location Reference**: [Line 547-549](#L547)
...
#### Navigation
**Location Reference**: [Line 559](#L559)
...
**Location Reference**: [Line 572](#L572)
...
**Location Reference**: [Line 575](#L575)
...
#### Find Send Button
**Location Reference**: [Line 596](#L596)
...
#### Click Button
**Location Reference**: [Line 602](#L602)
...
#### Execute JavaScript
**Location Reference**: [Line 591](#L591)
...
**Location Reference**: [Line 665](#L665)
...
#### Quit Driver
**Location Reference**: [Line 770](#L770)
...
**Location Reference**: [Line 585-588](#L585)
...
**Location Reference**: [Line 723-726](#L723)
...
**Location Reference**: [Line 699-713](#L699)
...
- For GitHub viewing, line references work as anchors (#L123 format)
